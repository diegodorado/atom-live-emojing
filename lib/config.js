  ...
  'playground': {
    ...
    properties: {
      'enabled': {
        type: 'boolean',
        default: true,
        description: 'Enable if you want to receive messages from live emojing Playground.'
      },
      'channelName': {
        type: 'string',
  ...
  'osc': {
    ...
    properties: {
      'enabled': {
        type: 'boolean',
        default: true,
        description: 'Enable if you want to run an OSC server to receive messages.'
      },
      'port': {
        type: 'integer',
        default: 3333,
        description: 'On which port do you want to run it?'
      }
    },
  },
  'ownershipTime': {
