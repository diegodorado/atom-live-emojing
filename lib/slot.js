...
export default class Slot {
  ...
  constructor(data) {
    ...
    const curPos = ed.getCursorBufferPosition()

    const r = ed.getSelectedBufferRange()
    ...
    ed.moveToEndOfLine()
    ed.insertText("   ")
    const r2 = ed.insertText(" ")[0]
    ed.insertText("  ") // so i can write afterwards
    const m2 = ed.markBufferRange(r2, {
      invalidate: 'never'
    })
